========================================================================
    STATISCHE BIBLIOTHEK: Gae-Projektübersicht 
========================================================================

Dieses Gae-Bibliotheksprojekt wurde vom Anwendungs-
Assistenten für Sie erstellt. 

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien,
aus denen Ihre Gae–Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    ...
    mit dem Namen "Gae.pch" und eine 
